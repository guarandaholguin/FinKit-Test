...
(function (k) {
	...
	function G(a) {
		...
		k.each(a, function (e, f) {
			(b = e.match(/^([^A-Z]+?)([A-Z])/)) &&
				...
				((c = e.replace(b[0], b[2].toLowerCase())), (d[c] = e), 'o' === b[1] && G(a[e]));
		});
		a._hungarianMap = d;
	}
	function O(a, b, c) {
	...
	function Bb(a, b, c, d, e, f) {
		...
		for (; d !== e; )
			a.hasOwnProperty(d) && ((h = g ? b(h, a[d], d, a) : a[d]), (g = !0), (d += f));
		return h;
	}
	function Wa(a, b) {
			...
			t = function (x) {
				if (c === q || c === h)
					(g = n[h]),
						(l = x.innerHTML.trim()),
						g && g._bAttrSrc
							? (da(g.mData._)(d, l), p(g.mData.sort, x), p(g.mData.type, x), p(g.mData.filter, x))
							: m
	...
	function Eb(a) {
		...
		for (b = h.length; l < b; l++) {
			...
			a.oFeatures.bSort &&
				...
				!1 !== n.bSortable &&
					(m.attr('tabindex', a.iTabIndex).attr('aria-controls', a.sTableId), db(a, n.nTh, l)));
			...
			for (d = f.length; l < d; l++) {
				...
				for (b = f[l].length; e < b; e++) {
					...
					if (g[l][e] === q) {
						...
						for (g[l][e] = 1; f[l + h] !== q && f[l][e].cell == f[l + h][e].cell; )
							(g[l + h][e] = 1), h++;
			...
			if (0 !== l.length)
				...
				(c = f.sZeroRecords),
					...
					(b[0] = k('<tr/>', { class: e ? d[0] : '' }).append(
						k('<td />', { valign: 'top', colSpan: na(a), class: a.oClasses.sRowEmpty }).html(c)
					)[0]);
			H(a, 'aoHeaderCallback', 'header', [k(a.nTHead).children('tr')[0], bb(a), g, n, l]);
		...
		for (var f = a.sDom.split(''), g, h, l, n, m, p, t = 0; t < f.length; t++) {
			...
			if ('<' == h) {
				...
				if ("'" == n || '"' == n) {
					...
					-1 != m.indexOf('.')
						? ((n = m.split('.')), (l.id = n[0].substr(1, n[0].length - 1)), (l.className = n[1]))
						: '#' == m.charAt(0)
	...
	function Jb(a) {
		...
		b = k('<div/>', { id: f.f ? null : c + '_filter', class: b.sFilter }).append(
			k('<label/>').append(h)
		);
		var l = function () {
	...
	function Sb(a) {
		for (var b = u.ext.search, c = a.aiDisplay, d, e, f = 0, g = b.length; f < g; f++) {
			for (var h = [], l = 0, n = c.length; l < n; l++)
				(e = c[l]), (d = a.aoData[e]), b[f](a, d._aFilterData, e, d._aData, l) && h.push(e);
			c.length = 0;
			k.merge(c, h);
		}
	}
	...
	function Ea(a) {
		...
		if (a.scrollBarVis !== ha && a.scrollBarVis !== q) (a.scrollBarVis = ha), ra(a);
			...
			'' === c
				? ((E.width = '100%'),
				  M &&
						(r.find('tbody').height() > h.offsetHeight || 'scroll' == m.css('overflow-y')) &&
		...
		if (d || (!t && !f && !e && h == na(a) && h == n.length))
			...
			for (v = 0; v < l.length; v++)
				(r = c[l[v]]),
					...
					r.sWidthOrig &&
						f &&
						k(n[v]).append(
							k('<div/>').css({ width: r.sWidthOrig, margin: 0, padding: 0, border: 0, height: 1 })
						);
			if (a.aoData.length)
				for (v = 0; v < l.length; v++)
			...
			for (v = e = 0; v < l.length; v++)
				(p = k(n[v])),
					...
					(p = x.bBounding ? Math.ceil(n[v].getBoundingClientRect().width) : p.outerWidth()),
					(e += p),
					(c[l[v]].sWidth = K(p - g));
			b.style.width = K(e);
			r.remove();
		...
		for (var d = 0, e = b.length; d < e; d++) {
			...
			f.bSortable &&
				(0 < c.length && c[0].col == d
					? (l.setAttribute('aria-sort', 'asc' == c[0].dir ? 'ascending' : 'descending'),
					  (f = g[c[0].index + 1] || g[0]))
					: (f = g[0]),
	...
	function Pa(a) {
		...
		if (e.bSort && e.bSortClasses) {
			...
			for (f = d.length; e < f; e++)
				(g = d[e].src), k(T(a.aoData, 'anCells', g)).addClass(c + (2 > e ? e + 1 : 3));
		}
		a.aLastSort = d;
	}
	function bc(a, b) {
	...
	var u = function (a) {
			...
			this.each(function () {
				...
				if ('table' != this.nodeName.toLowerCase())
					aa(null, 0, 'Non-table node initialisation (' + this.nodeName + ')', 2);
				else {
					yb(m);
					zb(m.column);
					O(m, m, !0);
					...
					r.iInitDisplayStart === q &&
						((r.iInitDisplayStart = g.iDisplayStart), (r._iDisplayStart = g.iDisplayStart));
					...
					g.bStateSave
						? ((M.bStateSave = !0), Q(r, 'aoDrawCallback', Qa, 'state_save'), dc(r, g, f))
						: f();
				}
			});
			b = null;
		...
		if (Array.isArray(a)) for (var c = 0, d = a.length; c < d; c++) D.register(a[c], b);
			...
			for (c = d.length; a < c; a++) {
				...
				a === c - 1
					? ((h.val = b),
					  (h.type =
							'function' === typeof b ? 'function' : k.isPlainObject(b) ? 'object' : 'other'))
	...
	w('draw()', function (a) {
		return this.iterator('table', function (b) {
			'page' === a
				? fa(b)
				: ('string' === typeof a && (a = 'full-hold' === a ? !1 : !0), ja(b, !1 === a));
		});
	});
	w('page()', function (a) {
		return a === q
	...
	var tb = function (a, b, c, d, e) {
			...
			for (h = b.length; n < h; n++) {
				...
				for (l = m.length; p < l; p++)
					(g = c('string' === typeof m[p] ? m[p].trim() : m[p])) && g.length && (f = f.concat(g));
			}
			a = L.selector[a];
			...
			if ('current' == b) for (g = a._iDisplayStart, a = a.fnDisplayEnd(); g < a; g++) c.push(d[g]);
				...
				for (g = 0, a = a.aoData.length; g < a; g++)
					'none' == f
						? c.push(g)
						: ((e = k.inArray(g, d)),
						  ((-1 === e && 'removed' == f) || (0 <= e && 'applied' == f)) && c.push(g));
			return c;
		},
		wc = function (a, b, c) {
			var d;
	...
	var xc = function (a, b, c, d) {
		...
		pc = function (a, b) {
			...
			c.length &&
				...
				((a = c[0].aoData[a[0]]),
				a._details &&
					((a._detailsShow = b) ? a._details.insertAfter(a.nTr) : a._details.detach(), yc(c[0])));
		},
		yc = function (a) {
			var b = new D(a),
				c = a.aoData;
				...
				b.on('column-visibility.dt.DT_details', function (d, e, f, g) {
					if (a === e)
						for (e = na(e), f = 0, g = c.length; f < g; f++)
							(d = c[f]), d._details && d._details.children('td[colspan]').attr('colspan', e);
				}),
				...
				if (null === r || r === q || A) {
					...
					for (p = e.length; m < p; m++)
						for (h = e[m], t = 0; t < l; t++)
							(v = { row: h, column: t }),
								A
									? ((x = d[h]), r(v, S(a, h, t), x.anCells ? x.anCells[t] : null) && n.push(v))
									: n.push(v);
					return n;
				}
				if (k.isPlainObject(r))
					return r.column !== q && r.row !== q && -1 !== k.inArray(r.row, e) ? [r] : [];
				A = g
					.filter(r)
					.map(function (E, I) {
		...
		d = this.iterator(
			...
			function (m, p) {
				...
				for (h = f[p].length; g < h; g++)
					for (l = 0, n = e[p].length; l < n; l++) m.push({ row: f[p][g], column: e[p][l] });
				return m;
			},
			1
		);
				...
				k(a.nTable).on('order.dt.DT', function (e, f, g, h) {
					a === f &&
						...
						b
							...
							.addClass(
								'asc' == h[e] ? d.sSortAsc : 'desc' == h[e] ? d.sSortDesc : c.sSortingClass
							));
				});
			},
				...
				k(a.nTable).on('order.dt.DT', function (e, f, g, h) {
					a === f &&
						...
						b
							...
							.addClass(
								'asc' == h[e] ? d.sSortJUIAsc : 'desc' == h[e] ? d.sSortJUIDesc : c.sSortingClassJUI
							));
				});
			},
		},
